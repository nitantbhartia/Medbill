...
<p>Peritoneal dialysis is the least expensive option and can be performed at home, often overnight while sleeping. It also avoids the 3-month Medicare waiting period if home training begins promptly. Despite these advantages, only about 10% of U.S. dialysis patients use peritoneal dialysis, partly because dialysis companies earn higher revenue from in-center hemodialysis.</p>
